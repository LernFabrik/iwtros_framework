...
namespace iwtros{
    namespace simulation{
        ...
        bool ConveyorSpawner::loadSpawnParameters(const XmlRpc::XmlRpcValue& p, SpawnParameters& spawn_params) const{
        ...
        bool ConveyorSpawner::loadObjectParameters(const XmlRpc::XmlRpcValue& object, ObjectParameters& object_params) const{
            ...
            try
            {
                ...
                ROS_INFO("Sucess..... mesh_resource");

                // Get the initial pose
                XmlRpc::XmlRpcValue& initial_pose = obj["initial_pose"];
                ROS_INFO("Sucess..... initial_pose");
                ...
                ROS_INFO("Sucess..... lateral_placement_variance");
                ...
                ROS_INFO("Sucess..... yaw_placement_variance");
                ...
                ROS_INFO("Sucess..... spawn_timing_variance");
            }
        ...
        bool ConveyorSpawner::start(std_srvs::EmptyRequest& req, std_srvs::EmptyResponse& res){
            ROS_INFO("Starting conveyor spawner...");
            timer_.start();
            return true;
        }

        bool ConveyorSpawner::stop(std_srvs::EmptyRequest& req, std_srvs::EmptyResponse& res) {
